...
export const get_tax1_wallet_address = () => {

    return process.env.TAX_WALLET1 as string
}

export const get_tax2_wallet_address = () => {

    return process.env.TAX_WALLET2 as string
}

export const get_tax3_wallet_address = () => {

    return process.env.TAX_WALLET3 as string
}
